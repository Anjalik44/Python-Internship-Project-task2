...
FONT, width=6, height=2, fg="#000000",
                      highlightbackground='#ADD8E6', highlightthickness=2)
btn_point.grid(row=5, column=2, sticky='nsew', padx=10, pady=10)

btn_div = tk.Button(root, text=chr(247), command=lambda: sc_app.Standard_Ops('/'),
                    font=FONT, width=6, height=2, fg="#000000",
                    highlightbackground='#ADD8E6', highlightthickness=2)
btn_div.grid(row=1, column=3, sticky='nsew', padx=10, pady=10)

btn_mult = tk.Button(root, text='x', command=lambda: sc_app.Standard_Ops('*'),
                     font=FONT, width=6, height=2, fg="#000000",
                     highlightbackground='#ADD8E6', highlightthickness=2)
btn_mult.grid(row=2, column=3, sticky='nsew', padx=10, pady=10)
...
btn_add = tk.Button(root, text='+', command=lambda: sc_app.Standard_Ops('+'),
                    font=FONT, width=6, height=2, fg="#000000",
                    highlightbackground='#ADD8E6', highlightthickness=2)
btn_add.grid(row=4, column=3, sticky='nsew', padx=10, pady=10)

btn_equals = tk.Button(root, text='=', command=lambda: sc_app.Standard_Ops('='),
                       font=FONT, width=6, height=2, fg="#000000",
                       highlightbackground='#ADD8E6', highlightthickness=2)
btn_equals.grid(row=5, column=3, sticky='nsew', padx=10, pady=10)

btn_pi = tk.Button(root, text='π', command=lambda: sc_app.Pi(),
                   font=FONT, width=6, height=2, fg="#000000",
                   highlightbackground='#ADD8E6', highlightthickness=2)
btn_pi.grid(row=1, column=4, sticky='nsew', padx=10, pady=10)

btn_e = tk.Button(root, text='e', command=lambda: sc_app.E(),
                  font=FONT, width=6, height=2, fg="#000000",
                  highlightbackground='#ADD8E6', highlightthickness=2)
btn_e.grid(row=1, column=5, sticky='nsew', padx=10, pady=10)

btn_degrees = tk.Button(root, text='Deg', command=lambda: sc_app.Deg(),
                        font=FONT, width=6, height=2, fg="#000000",
                        highlightbackground='#ADD8E6', highlightthickness=2)
btn_degrees.grid(row=2, column=4, sticky='nsew', padx=10, pady=10)

btn_radians = tk.Button(root, text='Rad', command=lambda: sc_app.Rad(),
                        font=FONT, width=6, height=2, fg="#000000",
                        highlightbackground='#ADD8E6', highlightthickness=2)
btn_radians.grid(row=2, column=5, sticky='nsew', padx=10, pady=10)

btn_sin = tk.Button(root, text='sin', command=lambda: sc_app.Sin(),
                    font=FONT, width=6, height=2, fg="#000000",
                    highlightbackground='#ADD8E6', highlightthickness=2)
btn_sin.grid(row=3, column=4, sticky='nsew', padx=10, pady=10)

btn_cos = tk.Button(root, text='cos', command=lambda: sc_app.Cos(),
                    font=FONT, width=6, height=2, fg="#000000",
                    highlightbackground='#ADD8E6', highlightthickness=2)
btn_cos.grid(row=3, column=5, sticky='nsew', padx=10, pady=10)

btn_tan = tk.Button(root, text='tan', command=lambda: sc_app.Tan(),
                    font=FONT, width=6, height=2, fg="#000000",
                    highlightbackground='#ADD8E6', highlightthickness=2)
btn_tan.grid(row=4, column=4, sticky='nsew', padx=10, pady=10)

btn_sinh = tk.Button(root, text='sinh', command=lambda: sc_app.Sinh(),
                     font=FONT, width=6, height=2, fg="#000000",
                     highlightbackground='#ADD8E6', highlightthickness=2)
btn_sinh.grid(row=4, column=5, sticky='nsew', padx=10, pady=10)
...
btn_tanh = tk.Button(root, text='tanh', command=lambda: sc_app.Tanh(),
                     font=FONT, width=6, height=2, fg="#000000",
                     highlightbackground='#ADD8E6', highlightthickness=2)
btn_tanh.grid(row=5, column=5, sticky='nsew', padx=10, pady=10)

btn_log = tk.Button(root, text='log', command=lambda: sc_app.Log_10(),
                    font=FONT, width=6, height=2, fg="#000000",
                    highlightbackground='#ADD8E6', highlightthickness=2)
btn_log.grid(row=6, column=4, sticky='nsew', padx=10, pady=10)

btn_ln = tk.Button(root, text='ln', command=lambda: sc_app.Ln(),
                   font=FONT, width=6, height=2, fg="#000000",
                   highlightbackground='#ADD8E6', highlightthickness=2)
btn_ln.grid(row=6, column=5, sticky='nsew', padx=10, pady=10)

btn_pow_2 = tk.Button(root, text='x^2', command=lambda: sc_app.Pow_2(),
                      font=FONT, width=6, height=2, fg="#000000",
                      highlightbackground='#ADD8E6', highlightthickness=2)
btn_pow_2.grid(row=6, column=3, sticky='nsew', padx=10, pady=10)

btn_pow_3 = tk.Button(root, text='x^3', command=lambda: sc_app.Pow_3(),
                      font=FONT, width=6, height=2, fg="#000000",
                      highlightbackground='#ADD8E6', highlightthickness=2)
btn_pow_3.grid(row=6, column=2, sticky='nsew', padx=10, pady=10)

btn_pow_10_n = tk.Button(root, text='10^x', command=lambda: sc_app.Pow_10_n(),
                         font=FONT, width=6, height=2, fg="#000000",
                         highlightbackground='#ADD8E6', highlightthickness=2)
btn_pow_10_n.grid(row=6, column=1, sticky='nsew', padx=10, pady=10)

btn_1_div_x = tk.Button(root, text='1/x', command=lambda: sc_app.One_div_x(),
                        font=FONT, width=6, height=2, fg="#000000",
                        highlightbackground='#ADD8E6', highlightthickness=2)
btn_1_div_x.grid(row=6, column=0, sticky='nsew', padx=10, pady=10)

btn_abs = tk.Button(root, text='|x|', command=lambda: sc_app.Abs(),
                    font=FONT, width=6, height=2, fg="#000000",
                    highlightbackground='#ADD8E6', highlightthickness=2)
btn_abs.grid(row=6, column=6, sticky='nsew', padx=10, pady=10)
